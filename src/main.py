...
class MotionPlanning:
    def __init__(self):
        ...
        self.random_seed = self.map_config.get("random_seed", None)  # Default to None if not present
    ...
    def run_prm(self):
        ...
        # Initialize Map
        map.generate_2D_map_with_obstacles(self.size_x, self.size_y, self.n_obs)
